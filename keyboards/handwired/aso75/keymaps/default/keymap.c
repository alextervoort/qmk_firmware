...
/* Colemak
 * .-----------------------------------------------------------------------.  .--------------------------------------------------------------.
 * | GESC   | 1      | 2      | 3      | 4      | 5      | -      |   F5   |  |  =     | 6      | 7      | 8      | 9      | 0      | DEL    |
 * |--------+--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+-----------------|
 * | TAB    | Q      | W      | F      | P      | G      | HOME   |   [    |  |  PG UP | J      | L      | U      | Y      | ;      | \      |
 * |--------+--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+-----------------+--------|
 * | BACKSP | A      | R      | S      | T      | D      | END    |   ]    |  |  PG DN | H      | N      | E      | I      | O      | '      |
 * |--------+--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------------------------+--------|
 * | LSHIFT | Z      | X      | C      | V      | B      | COPY   | PASTE  |  |   UP   | K      | M      | ,      | .      | /      | RSHIFT |
 * |--------+--------+--------+--------+--------+-----------------+--------|  |--------+--------+--------+-----------------+--------+--------|
 * | LCTRL  | LGUI   | LALT   | FN     | SPACE  | SPACE  | LEFT   | RIGHT  |  |  DOWN  | ENTER  | ENTER  | FN     | RALT   | RGUI   | RCTRL  |
 * '-----------------------------------------------------------------------'  '--------------------------------------------------------------'
 */

   KC_GESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_MINS, KC_F5,   KC_EQL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,  \
   ...
   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_COPY, KC_PSTE,   KC_UP,   KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
...
* |--------+--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------------------------+--------|
* | LSHIFT | Z      | X      | C      | V      | B      | COPY   | PASTE  |  |  UP    | N      | M      | ,      | .      | /      | RSHIFT |
* |--------+--------+--------+--------+--------+-----------------+--------|  |--------+--------+--------+-----------------+--------+--------|
* | LCTRL  | LGUI   | LALT   | FN     | SPACE  | SPACE  | LEFT   | RIGHT  |  |  DOWN  | ENTER  | ENTER  | FN     | RALT   | RGUI   | RCTRL  |
* '-----------------------------------------------------------------------'  '--------------------------------------------------------------'
*/
   ...
   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_COPY, KC_PSTE,            KC_UP,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,  \
   KC_LCTL, KC_LGUI, KC_LALT, LT(_FN, KC_SPC),  KC_SPC,  KC_SPC,  KC_LEFT, KC_RGHT, KC_DOWN, KC_ENT,  KC_ENT,  LT(_FN, KC_ENT),  KC_RALT, KC_RGUI, KC_RCTL   \
  ),
 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
 * | SELECT | CALC   | MYCOMP | MAIL   |        |        | P7     | P8     |  | P9     | P-     |        |        | PR SCR | SCR LK | F12    |
 * |--------+--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
 * | PREV   | PLAY   | NEXT   | RESET  |        |        | P4     | P5     |  | P6     | P+     |        | RESET  |        |        | PAUSE  |
 * |--------+--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
 * | VOL-   | MUTE   | VOL+   | APP    |        |        | P1     | P2     |  | P3     | PENT   |        | _CM    | _QW    |        | RSHIFT |
 * |--------+--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
 ...
 */
    ...
    KC_MSEL, KC_CALC, KC_MYCM, KC_MAIL, _______, KC_ASRP, KC_P7,   KC_P8,       KC_P9,   KC_PMNS, _______, _______, KC_PSCR, KC_SLCK, KC_F12, \
    KC_MPRV, KC_MPLY, KC_MNXT, RESET,   _______, KC_ASUP, KC_P4,   KC_P5,       KC_P6,   KC_PPLS, _______, RESET,   _______, _______, KC_PAUS, \
