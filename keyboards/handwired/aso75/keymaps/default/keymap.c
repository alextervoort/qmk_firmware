 ...
 */
   ...
   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    C(KC_C), C(KC_V),   KC_UP,   KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
...
*/
   ...
   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    C(KC_C), C(KC_V),            KC_UP,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,  \
   KC_LCTL, KC_LGUI, KC_LALT, LT(_FN, KC_SPC),  KC_SPC,  KC_SPC,  KC_LEFT, KC_RGHT, KC_DOWN, KC_ENT,  KC_ENT,  LT(_FN, KC_ENT),  KC_RALT, KC_RGUI, KC_RCTL   \
  ),
