...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* AT Copied from XD75 default QUERTY keymap */
/* QWERTY
 * .--------------------------------------------------------------------------------------------------------------------------------------.
 ...
 */
   ...
   KC_BSPC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_HOME, KC_DEL,  KC_PGUP, KC_H,    KC_J,    KC_K,    KC_L,    TD(TD_SCOLN), KC_ENT,   \
 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | VOL-   | MUTE   | VOL+   | APP    |        |        | P1     | P2     | P3     | PENT   |        |        |        |        | RSHIFT |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 ...
 */
 ...
 [_FN] = LAYOUT( /* FUNCTION */
    ...
    KC_VOLD, KC_MUTE, KC_VOLU, KC_APP,  _______, _______, KC_P1,   KC_P2,   KC_P3,   KC_PENT, _______, _______, _______, _______, KC_RSFT, \
