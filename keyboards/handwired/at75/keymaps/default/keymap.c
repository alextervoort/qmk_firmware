 ...
 */
   ...
   KC_LCTL, KC_LGUI, KC_LALT, LT(_FN, KC_SPC),  KC_SPC,  KC_SPC,  KC_LEFT, KC_DOWN, KC_RGHT, KC_ENT,  KC_ENT,  LT(_FN, KC_ENT),  KC_RALT, KC_RGUI, KC_RCTL   \
  ),
...
/* FUNCTION
 * .--------------------------------------------------------------------------------------------------------------------------------------.
 * | GESC   | F1     | F2     | F3     | F4     | F5     | NUM LK | P/     | P*     |F6      | F7     | F8     | F9     | F10    | F11    |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | SELECT | CALC   | MYCOMP | MAIL   |        |        | P7     | P8     | P9     | P-     |        |        | PR SCR | SCR LK | F12    |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | PREV   | PLAY   | NEXT   | STOP   |        |        | P4     | P5     | P6     | P+     |        | RESET  |        |        | PAUSE  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 ...
 */
    ...
    KC_GESC, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_NLCK, KC_PSLS, KC_PAST, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,   \
    KC_MSEL, KC_CALC, KC_MYCM, KC_MAIL, _______, KC_ASRP, KC_P7,   KC_P8,   KC_P9,   KC_PMNS, _______, _______, KC_PSCR, KC_SLCK, KC_F12, \
    KC_MPRV, KC_MPLY, KC_MNXT, KC_MSTP, _______, KC_ASUP, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, _______, RESET,   _______, _______, KC_PAUS, \
